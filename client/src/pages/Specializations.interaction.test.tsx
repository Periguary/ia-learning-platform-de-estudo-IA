...
describe("Specializations interactions", () => {
  beforeEach(() => {
    window.history.replaceState({}, "", "/specializations");
    navigate.mockClear();
  });
  ...
  it("filtra por ferramenta e mantém a área correspondente visível", () => {
    ...
    expect(window.location.search).toContain("q=OpenCV");
  ...
  it("filtra por área e permite abrir o módulo recomendado", async () => {
    render(<Specializations />);

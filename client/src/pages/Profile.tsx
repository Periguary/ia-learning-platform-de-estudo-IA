...
export default function Profile() {
  ...
  const handleSaveProfile = async () => {
    ...
    const nextPreferences = { name: profileName.trim(), bio: profileBio.trim(), avatarDataUrl: croppedAvatar, zoom: avatarZoom, offsetX: avatarOffsetX, offsetY: avatarOffsetY, publicEnabled: isPublicEnabled, highContrastNeon };

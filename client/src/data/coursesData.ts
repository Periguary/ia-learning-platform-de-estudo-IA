...
export const softwareEngineeringContent = {
  ...
  3: { title: "Arquitetura de Software", content: "Estrutura geral do sistema.\n\n**Arquiteturas:**\n1. Monolítica\n2. Microserviços\n3. Serverless\n4. Event-driven\n\n**Fluxo de uma aplicação de IA:**\n```mermaid\nflowchart LR\n  U[Usuário] --> API[API de aplicação]\n  API --> R[RAG e regras]\n  R --> M[Modelo de IA]\n  M --> API\n  API --> U\n```\n\n**Fluxo assíncrono para dados:**\n```mermaid\nsequenceDiagram\n  participant App\n  participant Fila\n  participant Worker\n  participant Banco\n  App->>Fila: Publica evento\n  Fila->>Worker: Entrega tarefa\n  Worker->>Banco: Persiste resultado\n  Banco-->>App: Consulta status\n```\n\n**Escolha:**\nDepende dos requisitos, latência, custo, observabilidade e capacidade de recuperação.", examples: ["Monolítica: Simples, tudo junto", "Microserviços: Escalável, independente", "Serverless: Sem gerenciar servidores", "Mermaid: flowchart e sequenceDiagram"] },

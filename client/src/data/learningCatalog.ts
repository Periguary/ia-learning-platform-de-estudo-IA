...
const phaseDefinitions = [
  ...
  },
  {
    ...
    description: "Compreenda redes neurais profundas e transforme imagens em percepções com CNNs, OpenCV e modelos visuais.",
    icon: "🧠",
    color: "from-red-500 to-pink-500",
    moduleIds: ["neural-networks", "computer-vision", "image-processing", "convolutional-neural-networks"],
    duration: "8 semanas",
    difficulty: "Avançado",
  },
  {
    ...
    moduleIds: ["llms", "cognitive-computing", "generative-neural-networks"],
    duration: "7 semanas",
    difficulty: "Avançado",
  },
  {
